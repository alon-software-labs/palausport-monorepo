...
export const CabinSelectionMap: React.FC<CabinSelectionMapProps> = ({ onSelect, selectedCabinIds = [] }) => {
  ...
  return (
    <div className="w-full py-4 sm:py-6 relative z-10">
      ...
      <div className="w-full max-w-[900px] mx-auto ml-auto bg-blue-50/50 dark:bg-slate-900/50 rounded-l-[1rem] rounded-r-[6rem] sm:rounded-r-[12rem] border-[3px] sm:border-4 border-slate-300 dark:border-slate-800 p-2 sm:p-4 shadow-inner relative flex font-sans items-center overflow-visible">
